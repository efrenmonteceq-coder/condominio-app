...
const [limiteGastoAdmin,
  ...
  // 🔥 CARGAR DATOS
  // Esperamos a que useAuth tenga disponible el condominio del usuario.
  // Esto evita que en el celular la primera carga quede atrapada en
  // "Cargando urbanización..." por una condición de carrera.
