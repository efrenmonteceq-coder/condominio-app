    ...
    const alicuotasPendientes = pagosPersonales
      ...
      .sort((a, b) => {
        const fechaA = a.fecha_vencimiento
          ? new Date(String(a.fecha_vencimiento)).getTime()          : Number.POSITIVE_INFINITY;
      ...
      <div className="residente-mobile">
        <style dangerouslySetInnerHTML={{ __html: `
          @media (max-width: 680px) {
            .residente-mobile .residente-mobile-title { font-size: 18px !important; line-height: 1.28 !important; }
            .residente-mobile .residente-mobile-subtitle { font-size: 13.5px !important; line-height: 1.4 !important; }
            .residente-mobile .residente-mobile-resumen-title { font-size: 19px !important; }
            .residente-mobile .residente-mobile-mini strong { font-size: 22px !important; }
            .residente-mobile .residente-mobile-mini small { font-size: 13px !important; line-height: 1.25 !important; }
            .residente-mobile .residente-mobile-mini > div { font-size: 12.5px !important; line-height: 1.4 !important; }
            .residente-mobile .residente-mobile-condominio,
            .residente-mobile .residente-mobile-vivienda { font-size: 15px !important; }
          }
        ` }} />
        ...
        <div className="residente-mobile-resumen">
          ...
          >
            ...
            <div className="residente-mobile-mini">
              ...
              <div style={{ marginTop: 5, color: "#64748b", fontSize: 11, lineHeight: 1.35 }}>
                {avisosPendientesResidente === 0
                  ? "No tienes avisos pendientes."                  : "Avisos publicados que aún no has leído."}
              </div>
            </div>
          </div>
        </div>
    ...
    <>
      ...
      >
        ...
        >
          ...
          <CardPremium
            titulo="⚙️ Configuración Financiera"            valor="Consultar"
            color="#7c3aed"
            onClick={() =>
              router.push(
...
const guardiaMobileStyles = `
  ...
  @media (max-width: 680px) {
    ...
    .guardia-mobile-card-title { font-size:18px; line-height:1.18; font-weight:800; margin-bottom:5px; }
    .guardia-mobile-card-value { font-size:23px; line-height:1.05; font-weight:900; margin-bottom:6px; }
    .guardia-mobile-card-subtitle { font-size:13.5px; line-height:1.4; opacity:.78; max-width:92%; }
    ...
    .guardia-mobile-resumen-title { display:flex; align-items:center; gap:8px; font-size:18px; font-weight:800; color:#111827; margin-bottom:13px; }
    ...
    .guardia-mobile-mini strong { display:block; font-size:23px; line-height:1.1; color:#111827; }
    .guardia-mobile-mini small { display:block; margin-top:4px; font-size:13px; color:#64748b; line-height:1.25; }
    @media (max-width:390px) { .guardia-mobile-grid{gap:9px;} .guardia-mobile-card{min-height:178px;padding:16px 13px 14px;} .guardia-mobile-card-title{font-size:17px;} .guardia-mobile-card-value{font-size:21px;} .guardia-mobile-card-subtitle{font-size:13px;} .guardia-mobile-icon{width:50px;height:50px;min-width:50px;font-size:24px;} .guardia-mobile-hola{font-size:20px;} .guardia-mobile-avatar{width:60px;height:60px;min-width:60px;font-size:29px;} }
  }
`;
...
const directivaMobileStyles = `
  ...
  @media (max-width: 680px) {
    ...
    .directiva-mobile-section-title { font-size:17px; font-weight:800; color:#111827; margin:0 0 10px; }
    ...
    .directiva-mobile-card-title { font-size:17px; line-height:1.28; font-weight:800; color:#111827; }
    .directiva-mobile-card-value { margin-top:5px; font-size:22px; font-weight:900; color:#1d4ed8; }
    .directiva-mobile-card-subtitle { margin-top:5px; font-size:13.5px; line-height:1.4; color:#64748b; }
    ...
    .directiva-mobile-resumen-title { display:flex; align-items:center; gap:8px; font-size:17px; font-weight:800; color:#111827; margin-bottom:12px; }
    ...
    .directiva-mobile-mini strong { font-size:22px; color:#1d4ed8; }
    .directiva-mobile-mini small { color:#64748b; font-size:12.5px; margin-top:2px; }
...
const adminMobileStyles = `
  ...
  @media (max-width: 680px) {
    ...
    .admin-mobile-account-title { font-size:18px; line-height:1.22; font-weight:900; color:#1e3a8a; }
    .admin-mobile-account-subtitle { margin-top:4px; font-size:13.5px; line-height:1.4; color:#475569; }
    ...
    .admin-mobile-card-title { font-size:18px; line-height:1.18; font-weight:800; margin-bottom:5px; }
    .admin-mobile-card-value { font-size:25px; line-height:1.05; font-weight:900; margin-bottom:6px; }
    .admin-mobile-card-subtitle { font-size:13.5px; line-height:1.4; opacity:.78; max-width:92%; }
    ...
    .admin-mobile-alert-text strong { font-size:15px; line-height:1.22; }
    .admin-mobile-alert-text span { font-size:13px; opacity:.78; line-height:1.3; }
